...
$string['presetfiles_desc'] = 'Voreinstellungsdateien können verwendet werden, um das Erscheinungsbild des Themes drastisch zu verändern. Unter <a href=https://docs.moodle.org/dev/Boost_Presets>Boost presets</a> finden sich Informationen zum Erstellen und Freigeben eigener Voreinstellungsdateien und im <a href=http://moodle.net/boost>Presets repository</a> befinden sich Voreinstellungen, die andere freigegeben haben.';
// Preset setting.
